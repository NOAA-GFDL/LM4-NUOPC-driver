...
contains
  ...
  !   real, parameter :: RDGAS  = 287.04_r8_kind           !< Gas constant for dry air [J/kg/deg]
  !   real, parameter :: RVGAS  = 461.50_r8_kind           !< Gas constant for water vapor [J/kg/deg]
  !   real, parameter :: KAPPA  = 2.0_r8_kind/7.0_r8_kind  !< RDGAS / CP_AIR [dimensionless]
  ...
  subroutine flux_down_from_atmos(Land,Atm)

    type(atmos_land_boundary_type), intent(inout)  :: Atm  !< A derived data type to specify atmosphere boundary data
    type(land_data_type),  intent(inout)  :: Land !< A derived data type to specify land boundary data 
