...
!> @author modified for LM4 by Justin.Perket@noaa.gov @date 08-19-2024
!>
...
contains
  ...
  subroutine SetScalarField(field, flds_scalar_name, flds_scalar_num, rc)
    ...
    character(len=*), parameter :: subname='(lm4_comp_cplscalars:SetScalarField)'
    ! ----------------------------------------------
  ...
  subroutine State_SetScalar(scalar_value, scalar_id, State, flds_scalar_name, flds_scalar_num,  rc)
    ...
    character(len=*), parameter :: subname = ' (lm4_comp_cplscalars:state_setscalar) '
    ! ----------------------------------------------
  ...
  subroutine State_GetScalar(state, scalar_id, scalar_value, flds_scalar_name, flds_scalar_num, rc)
    ...
    character(len=*), parameter :: subname = ' (lm4_comp_cplscalars:state_getscalar) '
    ! ----------------------------------------------
...
end module lm4_comp_cplscalars
